...
@export var harvest_swings_required := 3 ##the amount of animation swings to harvest
@export var harvest_animation_time := 0.6
@export var harvest_range := 200

@export_group("Misc Stats")
@export var aggro_range := 500 ##Aggro range when IDLE
...
@export var is_passive := false ##whether or not this unit actively scans for and attacks enemies while idle.
